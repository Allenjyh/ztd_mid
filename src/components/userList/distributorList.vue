<template>
  <el-row>
    <div class="librarian userList">
        <div class="librarian_title">用户列表<span class="librarian_title_child">/ 配送员列表</span></div> 
      ...
      let me = this;  
        me.$requestAxios(me,{
          url : 'userList',
            data : {} ,
            method : 'get',
            urlParam :'?user_type=2&limit=12&currentPage='+(me.currentPage?me.currentPage:'0')+(phone?'&search='+phone:''),  
        },function(res,opt){ 
            // console.log(res)
...
<style   >
   ...
   /*过滤 */
    .el-checkbox__input.is-checked .el-checkbox__inner, .el-checkbox__input.is-indeterminate .el-checkbox__inner  {
      background-color: rgba(103,207,220,1);
      border-color: rgba(103,207,220,1);
   }
